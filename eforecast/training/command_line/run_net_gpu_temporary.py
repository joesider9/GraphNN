...
path_weights = ('/media/sider/data/Dropbox/data_transfer/models/PPC/PPC_sat_ver1/pv/Ptolemaida/'
                'multi-output/model_ver0/global/TIMM/test_9')
gpu_id = 0
refit = bool(1)
...
if __name__ == '__main__':
    ...
    if 'feature_selection_method' in params.keys():
        params['feature_selection_method'] = None if isinstance(params['feature_selection_method'], float) else \
            params['feature_selection_method']
    trainer = Trainer(static_data, params, True)
