...
class FilesManager:
    ...
    def check_if_exists_row_data(self, get_all=False):
    ...
    def check_if_exists_image_data(self, get_all=False):
    ...
    def save_images(self, image_data, image_stats):
        file = self.file_images()
        data = dict()
        data['dates'] = image_data
        data['stats'] = image_stats
