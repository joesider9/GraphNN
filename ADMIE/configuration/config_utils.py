...
def find_pycharm_path():
    if not os.path.exists('/media/sider/data'):
        ...
        pycharm_path = '/media/sider/data/Dropbox/current_codes/PycharmProjects'
    return pycharm_path
...
def config_folders(docker):
    ...
    if docker:
        ...
        if not os.path.exists('/media/sider/data'):
            ...
            folders['path_image'] = '/media/smartrue/FastAssistant/SAT_DATA'
        else:

            folders['sys_folder'] = '/media/sider/data//models/'
            folders['nwp_folder'] = '/media/sider/data/Dropbox/'
