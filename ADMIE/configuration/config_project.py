...
if not ('smartrue' in os.getcwd() or 'PycharmProjects' in os.getcwd()):
    DOCKER = True
PROJECT_NAME = ''
PROJECT_GROUP = 'RejectedPower'
PROJECT_OWNER = 'ADMIE'

HORIZON_TYPE = 'intra-output'  # day-ahead, multi-output, intra-ahead
HORIZON = 0  # If horizon is 0 horizon type is day-ahead
...
AREA_GROUP = []
IMAGE_COORD = {}
USE_IMAGES = None  # ['eumetdac', 'eumetview']
SITE_INDICES = {}
IMAGE_SIZE = {}
...
FILE_NAME = ''
EVALUATION_START_DATE = ''  # '%Y-%m-%d %H:%M or None
LOCAL_TIME_ZONE = 'Europe/Athens'  # 'Europe/Athens', 'UTC', 'CET'
SITE_TIME_ZONE = 'Europe/Athens'  # 'Europe/Athens', 'UTC', 'CET'
COUNTRY = 'Greece'
TS_RESOLUTION = '1min'  # 'H' for hourly or 'D' for daily or '15min'
TIME_OFFSET = 0
